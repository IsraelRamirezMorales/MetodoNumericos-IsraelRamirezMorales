...
def biseccion(a, b, tol, max_iter, cifras):
    """
    Método de biseccion para encontrar la raíz de la ecuación f(x) = 0.
    ...
    for i in range(max_iter):
        # Calcular el punto de biseccion
        c = (a+b)/2
        fc = f(c)
...
def main():
    ...
    print("-BIENVENIDO AL METODO (CERRADO) BISECCION-")
    ...
    try:
        resultado = biseccion(a, b, tol, 100, n)  # 100 iteraciones como máximo
