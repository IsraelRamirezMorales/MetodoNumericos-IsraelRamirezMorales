...
def newton_raphson(x0, tol, max_iter, cifras):
    """
    Método de Newton Raphson para encontrar la raiz
    
    :param x0: Valor inicial de la iteración
    ...
    """
    print(f"{'i':<5}{'xi':<15}{'f(xi)':<15}{'f_prima(xi)':<15}{"xi+1":<15}{'Error Relativo':<15}")
    print("-" * 80)
    ...
    for i in range(0, max_iter + 1):
        ...
        print(f"{i:<5}{xi_red:<15}{f_xi_red:<15}{f_prima_xi_red:<15}{xi_nuevo_red:<15}{Er_red:<15}")
...
def main():
    ...
    try:
        resultado = newton_raphson(x0, tol, 100, n)  # 100 iteraciones como máximo
